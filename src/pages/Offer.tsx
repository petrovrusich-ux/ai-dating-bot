          ...
          <div className="space-y-6 text-card-foreground">
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li>Флирт - 1490₽ за 7 дней, до 50 сообщений в день
</li>
                <li>Интим - 1990₽ за 7 дней, безлимитное общение
</li>
                <li>Одна девушка - 590₽ за 24 часа с одним персонажем
</li>
                <li>Все девушки - 990₽ за 24 часа со всеми персонажами
</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">Оплата услуг производится через платежную систему platega.io. Все платежи являются разовыми и не продлеваются автоматически. Для продления доступа необходимо совершить новую оплату.</p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">Исполнитель не несет ответственности за: 
- Временные технические сбои, не зависящие от него. 
- Содержание диалогов, созданных AI.  
- Использование бота в целях, противоречащих законодательству РФ.
- Любые последствия, возникшие в результате использования сервиса.
Весь контент предоставляется "как есть" в развлекательных целях. Сервис предназначен только для лиц старше 18 лет.</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold mb-3">7. Персональные данные</h2>
              <p className="text-muted-foreground leading-relaxed">Пользователь соглашается на обработку предоставленных персональных данных (имя пользователя,почта) в целях предоставления услуг. Исполнитель обязуется не передавать данные третьим лицам, за исключением случаев, предусмотренных законодательством РФ.</p>
            </section>
