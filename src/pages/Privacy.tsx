          ...
          <div className="space-y-6 text-card-foreground">
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li>Идентификационные данные: имя пользователя, почта</li>
                <li>Платежная информация: данные о транзакциях через платежную систему platega.io
</li>
            ...
            <section>
              ...
              <div className="text-muted-foreground leading-relaxed space-y-3">
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  ...
                  <li>Обработка платежей и управление тарифами</li>
            ...
            <section>
              ...
              <div className="text-muted-foreground leading-relaxed space-y-3">
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>Платежная система platega.io - для обработки платежей (в минимальном необходимом объеме)
</li>
